    ...
    return (
      <Link href={`/game/${this.game.id}`}>
        <a className='game-item relative group max-h-72 cursor-pointer'>
          ...
          <div className='absolute w-full h-full top-4 left-4 rounded-lg transition duration-400 p-2 bg-gray-700 bg-cover'>
            <Image src={this.game.img} layout='fill' className='rounded-lg' />
          </div>
        </a>
      </Link>
    )
