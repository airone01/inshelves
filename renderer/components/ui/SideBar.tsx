    ...
    <>
      <div className='flex flex-row justify-evenly items-center h-8 w-12 fixed top-0 left-0 z-10 no-select no-drag'>
        <button className="h-full w-full flex justify-center items-center hover:bg-gray-700 title-button">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" height="24px" width="24px" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
      ...
      <div className="fixed top-0 left-0 h-screen w-12 flex flex-col bg-gray-800 shadow-lg">
        ...
        <ul>
          {tabs.map(e => 
            <li key={e.toString()} className="bg-blue-500 blur">
              <button className="flex justify-center items-center h-12 w-full p-3 title-button bg-gray-800 hover:bg-blue-500 rounded-none">
                {e}
              </button>
            </li>
          )}
