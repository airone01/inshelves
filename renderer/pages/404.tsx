...
function p404 (): React.ReactElement {
  return (
    <div className='flex flex-col justify-center items-center h-screen whitespace-nowrap overflow-hidden'>
      <h1 className='text-7xl font-bold text-white z-10'>Sheeeeesh...</h1>
      <h2 className='text-3xl font-semibold text-gray-200 z-10'>There was an error in the app 🤔</h2>
      <h4 className='text-lg font-semibold text-gray-400 z-10'>You can go back by <Link href='/grid'><span className='underline cursor-pointer'>clicking here</span></Link>.</h4>
